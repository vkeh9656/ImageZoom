...
CImageZoomDlg::CImageZoomDlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_IMAGEZOOM_DIALOG, pParent)
{
...
// CImageZoomDlg 메시지 처리기

BOOL CImageZoomDlg::OnInitDialog()
{
...
//  이 함수를 호출합니다.
HCURSOR CImageZoomDlg::OnQueryDragIcon()
{
